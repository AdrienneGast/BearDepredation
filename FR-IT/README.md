...
5. **ESM EUROPEAN SETTLEMENT MAP**
    ...
    3. Quick visualization (with TCD, roads etc) slection of
    4. Do we rasterize? Or do we keep it in shapefiles to compute "true" distances?

5. **ROADS**
    1. from overpass turbo https://overpass-turbo.eu/    
    For PYR  
    we extract 
               track, footway, path **OK (23/01/2019)** 
               motorway, trunk, primary, secondary, tertiary, unclassified, road for highwayroads    
    ...
    we extract  
     ...
     2. Merge the data with 3 categories 1:paved roads, 2:unpaved roads, 3:foot trails
     3. Do we rasterize? Or do we keep it as shapefiles to compute "true" distances?
